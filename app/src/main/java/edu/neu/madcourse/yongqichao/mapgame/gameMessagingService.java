...
public class gameMessagingService extends FirebaseMessagingService {
    ...
    private static final String TAG = edu.neu.madcourse.yongqichao.mapgame.gameMessagingService.class.getSimpleName();
    ...
    private void sendNotification(String title, String messageBody) {
        Intent intent = new Intent(this, mapgameMain.class);
